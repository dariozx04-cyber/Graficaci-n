# Actividad Realidada Aumentada
Dario Padilla Moreno

## Actividad A — Medición del marcador
Si colocas un valor que es el doble del tamaño real (por ejemplo 0.20 m en lugar de 0.10 m), el sistema creerá que el marcador es más grande de lo que realmente es.
La estimación de la distancia cambiará y el objeto virtual parecerá estar más lejos o con una escala incorrecta.
Esto provoca que el objeto en realidad aumentada no coincida bien con la posición real del marcador.
